...
from sit_lmpc.models.bijectors import InverseConditional, ChainConditional, TransformedConditional, MaskedCouplingConditional
...
class NeuralSplineFlow(nn.Module):
    ...
    def sample(self, x, context: Array = None) -> Array:
        return self.flow.sample(x, context=context)
